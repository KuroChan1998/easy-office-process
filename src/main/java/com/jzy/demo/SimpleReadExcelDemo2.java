...
/**
 * @ClassName SimpleReadExcelDemo
 * @Author JinZhiyun
 * @Description 一个简单的读excel示例，处理的示例表格为项目example目录下的test1.et
 * @Date 2020/4/1 10:59
 * @Version 1.0
 **/
public class SimpleReadExcelDemo2 {
    public static void main(String[] args) throws IOException, InvalidFileTypeException {
        //改成你实际的文件路径
        String filePath = "E:\\Engineering\\java\\idea\\excel-processing\\example\\test1.et";
        //通过文件绝对路径构造excel对象
